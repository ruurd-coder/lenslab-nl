            ...
            {!sent ? (
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-gray-500">
                    Vul je e-mailadres in. Je ontvangt een aanmeldlink — geen wachtwoord nodig.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    {loading ? "Versturen..." : "Stuur aanmeldlink →"}
                  </button>
                </form>
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  We hebben een aanmeldlink gestuurd naar <strong>{email}</strong>.
