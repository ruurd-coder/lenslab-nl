...
type Feature = { label: string; included: boolean | string };
...
const TIERS: {
...
}[] = [
  {
    ...
    price: "Gratis",
    period: "",
    description: "Starten op het platform en direct zichtbaar worden.",
    featured: false,
    cta: "Gratis aanmelden",
    ctaLink: "/login",
    features: [
      { label: "Zichtbaar op listing pagina's", included: true },
      { label: "Landingspagina's (provincie)", included: "1 locatie" },
      { label: "Actieve categorieën", included: "1" },
      { label: "Foto's per portfolio", included: "10 foto's" },
      ...
      { label: "Review-tool", included: true },
      { label: "Andere beeldmakers zichtbaar op profiel", included: true },
      { label: "Uitgelicht op home / categorie pagina's", included: false },
    ],
  },
  {
    name: "Plus",
    price: "€7",
    period: "/maand",
    description: "Meer zichtbaarheid en een completer profiel voor groeiende fotografen.",
    featured: true,
    cta: "Start met Plus",
    ctaLink: "mailto:hello@lenslab.nl?subject=Plus membership",
    features: [
      { label: "Zichtbaar op listing pagina's", included: "Boven Free" },
      { label: "Landingspagina's (provincie)", included: "3 locaties" },
      { label: "Actieve categorieën", included: "4" },
      { label: "Foto's per portfolio", included: "10 foto's" },
      { label: "Link naar website", included: true },
      { label: "Link naar socials", included: true },
      { label: "Ontvang emails direct vanuit potentiële opdrachtgevers", included: true },
      { label: "Review-tool", included: true },
      { label: "Andere beeldmakers zichtbaar op profiel", included: false },
      { label: "Uitgelicht op home / categorie pagina's", included: false },
    ],
  },
  {
    ...
    price: "€14",
    period: "/maand",
    description: "Maximum zichtbaarheid en uitgelicht op het hele platform.",
    featured: false,
    cta: "Start met Premium",
    ctaLink: "mailto:hello@lenslab.nl?subject=Premium membership",
    features: [
      { label: "Zichtbaar op listing pagina's", included: "Boven Plus" },
      { label: "Landingspagina's (provincie)", included: "Onbeperkt" },
      { label: "Actieve categorieën", included: "8" },
      { label: "Foto's per portfolio", included: "10 foto's" },
      { label: "Link naar website", included: true },
      { label: "Link naar socials", included: true },
      { label: "Ontvang emails direct vanuit potentiële opdrachtgevers", included: true },
          ...
          {TIERS.map((tier) => (
            ...
            >
              ...
              <div className="flex items-baseline gap-1.5 mb-1">
                ...
                {tier.period && (
                  <span className="text-[14px]" style={{ color: "rgba(3,0,5,0.5)" }}>{tier.period}</span>
                )}
              </div>

              {/* Facturering */}
              <p className="text-[13.5px] leading-snug mt-2 mb-5 min-h-[40px]" style={{ color: "rgba(3,0,5,0.6)" }}>
                {tier.price === "Gratis" ? "Geen creditcard nodig." : "Jaarlijks gefactureerd."}
              </p>
                  ...
                  <li key={i} className="flex items-start gap-2.5">
                    ...
                    <span className="text-[14px] leading-snug" style={{ color: "#030005" }}>
                      ...
                      {typeof f.included === "string" && (
                        <strong className="ml-1">{f.included}</strong>
                      )}
                    </span>
                  </li>
                ))}
